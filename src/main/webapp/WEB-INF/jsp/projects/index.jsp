<%@ include file="../../../header.jsp" %> 
		...
		<c:forEach items="${projects}" var="project">
			...
			<a href="${pageContext.request.contextPath}/projects/${project.id}/edita" class="btn primary"><fmt:message key="project.edit"/></a>
			<br /><br />
			<form action="${pageContext.request.contextPath}/projects/${project.id}" method="post">
				<input type="hidden" name="_method" value="delete"/>
				<button type="submit" class="btn primary" onclick="return confirm('Are you sure?')">Remover</button>
			</form>
			<hr/>
		</c:forEach><br /><br /><br />
		<a href="/xisp/projects/newProject" class="btn large"><fmt:message key="project.novo"/></a>
	</div>
